...
<tr>
	<td><label for="height_<?php echo esc_attr( $field['id'] ) ?>"><?php _e_gfirem( "Height" ) ?></label></td>
	  <td>
        <label for="height_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _gfirem( "Height of the signature pad, by default '150'. " ) ) ?></label>
...
<td><label for="width_<?php echo esc_attr( $field['id'] ) ?>"><?php _e_gfirem( "Width" ) ?></label></td>
	  <td>
        <label for="width_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _gfirem( "Width of the signature pad, by default '300'. " ) ) ?></label>
...
<tr>
	  <td><label for="pencolor_<?php echo esc_attr( $field['id'] ) ?>"><?php _e_gfirem( "penColor" ) ?></label></td>
	  <td>
        <label for="pencolor_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _gfirem( "Color used to draw the lines. Can be any color format accepted by context.fillStyle. Defaults to 'black'" ) ) ?></label>
...
<tr>
    <td><label for="backgroundcolor_<?php echo esc_attr( $field['id'] ) ?>"><?php _e_gfirem( "Background color" ) ?></label></td>
    <td>
        <label for="backgroundcolor_<?php echo esc_attr( $field['id'] ) ?>" class="howto"><?php echo esc_attr( _gfirem( "Select background color, by default White" ) ) ?></label>
