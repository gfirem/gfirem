...
class pdf_button extends gfirem_field_base {
	
	public function __construct() {
		parent::__construct( 'pdf_button', gfirem_manager::translate( 'PDF' ),
			array( 'pdf_button_url' => '', ),
			gfirem_manager::translate( 'Generate a PDF from the URL put in the options' ),
