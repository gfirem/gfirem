<?php if ( gfirem_fs::getFreemius()->is_plan__premium_only( gfirem_fs::$professional ) ): ?>
    ...
    <tr>
        <td>
            <label for="field_options[autocomplete_target_form_<?php echo $field['id'] ?>]"><?php gfirem_manager::echo_translated( "Get option from" ); ?></label>
        </td>
    ...
    <tr>
        <td>
            <label for="field_options[autocomplete_target_filter_<?php echo $field['id'] ?>]"><?php gfirem_manager::echo_translated( "Select the filter field" ); ?></label>
        </td>
        <td>
    ...
    <tr>
        <td>
            <label for="field_options[autocomplete_target_filter_group_<?php echo $field['id'] ?>]"><?php gfirem_manager::echo_translated( "Group filtered result" ); ?></label>
        </td>
        <td>
